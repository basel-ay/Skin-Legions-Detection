...
class Vascular_lesion extends StatefulWidget {
  const Vascular_lesion({ Key? key }) : super(key: key);

  @override
  State<Vascular_lesion> createState() => _Vascular_lesionState();
}

class _Vascular_lesionState extends State<Vascular_lesion> {
  bool agree = false;
   var infotxt;
  ...
  Future<void> _loadData() async {
    final _loadedData = await rootBundle.loadString('assets/2.txt');
    setState(() {
      infotxt = _loadedData;
      print(infotxt);
    });
      ...
      appBar: AppBar(
        ...
        flexibleSpace: Expanded(
          child: Container(
            ...
            child: Text('Vascular Lesion',style: TextStyle(fontSize:20,color: Colors.white ,fontWeight:FontWeight.bold),),
