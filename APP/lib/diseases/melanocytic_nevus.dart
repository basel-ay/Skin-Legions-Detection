...
class Melanocytic_nevus extends StatefulWidget {
  const Melanocytic_nevus({ Key? key }) : super(key: key);

  @override
  State<Melanocytic_nevus> createState() => _Melanocytic_nevusState();
}

class _Melanocytic_nevusState extends State<Melanocytic_nevus> {
 bool agree = false;
   var infotxt;
  ...
  Future<void> _loadData() async {
    final _loadedData = await rootBundle.loadString('assets/5.txt');
    setState(() {
      infotxt = _loadedData;
      print(infotxt);
    });
      ...
      appBar: AppBar(
        ...
        flexibleSpace: Expanded(
          child: Container(
            ...
            child: Text('Melanocytic nevus ',style: TextStyle(fontSize:20,color: Colors.white ,fontWeight:FontWeight.bold),),
